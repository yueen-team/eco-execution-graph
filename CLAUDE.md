...
This project is indexed by GitNexus as **eco-execution-graph** (2616 symbols, 4347 relationships, 213 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
