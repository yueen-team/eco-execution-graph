...
它不对外只叫"环保知识图谱":内部叫**环保现场执行图谱**,政府侧叫**生态环境法典行业现场执行图谱**,企业侧叫**环保管家智能底座**,战略层叫**环保语义操作系统**。

- **现场经验为内容**(EcoCheck 每月 100+ 家企业的蒸馏流),**公开标准为骨架**;
- **每条边带 source_ref + confidence**,置信度由真实整改成效"挣"出来;
- **三层授权**:共有层(可与政府共建/软著)、私有层(商业壁垒,永不导出)、聚合层(只出统计不出个体),节点/边/source 出生即带 tier;
- **法条全文不进图**:图里是瘦节点 + 义务谓词 + 关系化法典沿革边,全文从腾讯云知识引擎 RAG 取。
...
| `docs/plans/2026-06-10-phase-one-hazardous-waste-slice.md` | 一阶段 14 天危废精品切片实施计划 |
| `docs/adr/` | 架构决策记录(9 条) |
