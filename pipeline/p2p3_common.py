...
from p2p3_graph_records import confidence_value, edge_record, node_record, safe_id, source_record
from p2p3_io import read_csv, rel, run_git, write_md_table
from p2p3_paths import (
    DEFAULT_ECO_KB,
    DEFAULT_ECO_KB_MANIFEST,
    ECO_KB,
    ECO_KB_MANIFEST,
    FULL_INTERNAL,
    FULL_SHARED,
    ...
    TODAY,
    UPSTREAM_DIR,
    resolve_eco_kb_manifest_path,
    resolve_eco_kb_root,
)
from p2p3_review_overrides import (
    ETO_REVIEW_OVERRIDES,
    ETO_SHARED_CARD_FIELDS,
    ETO_V4_CONCLUSION_SOURCE,
    hazardous_slice_role,
    is_hazardous_card,
    is_hazardous_text,
    load_eto_review_overrides,
)
from p2p3_upstream_helpers import collect_upstream_assets, upstream_repo_info
...
def build_upstream_lock() -> dict[str, Any]:
    ...
    assets = collect_upstream_assets(repos, ("manifests/*.json", "contracts/*.md", "contracts/*.json", "tests/*graph*.json"))
    lock = {
        "generated_at": TODAY,
        "repos": repos,
