...
def build():
    ...
    for issue in ISSUES:
        ...
        edges.extend([
            ...
            edge(f"edge:obligation:{issue['slug']}", issue["obligation"], issue["law"], "obligation_of", "shared", "src:demo:law-map", issue["confidence"], shared_reasons, issue["evidence_count"], "internal_reviewed", report_usage_policy="参考相关要求"),
            ...
            edge(f"edge:limited:{issue['slug']}", issue_id, issue["tech_spec"], "limited_by", "shared", "src:demo:law-map", issue["confidence"] - 0.02, shared_reasons, issue["evidence_count"], "internal_reviewed", report_usage_policy="参考相关要求"),
