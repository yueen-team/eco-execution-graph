...
- p0_p1_closure: {'report': 'reports/ecocheck-graph-p0-p1-closure-2026-06-22.json', 'token_alignment': 'pass', 'synthetic_live_smoke': 'pass', 'aggregate_pitfall_transport': 'pass_transport_blocked_by_no_approved_real_samples', 'not_verified': ['CloudBase graph-api storage driver cannot be proven from the public graph-api surface or CloudBase CLI list output without a dedicated non-secret diagnostics endpoint or console evidence.', 'Enterprise WeCom login callback was not exercised because no live扫码 session was initiated in this verification.']}
...
## External Pending
- government_lineage_real_import: interface_reserved_waiting_for_government_confirmed_exchange_file
- real_ecocheck_aggregate_pitfall_map: transport_verified_waiting_for_app_flow_and_real_aggregate_data
- eto_blind_review_for_monthly_comparison: waiting_for_app_flow_and_real_desensitized_samples
